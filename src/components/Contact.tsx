  ...
  const platforms = [
    {
      name: 'LinkedIn',
      icon: Linkedin,
      href: 'https://www.linkedin.com/in/ashutosh-singh-4b9a93230/',
    ...
    },
    {
      name: 'Fiverr',
      icon: ExternalLink,
      href: 'https://www.fiverr.com/techh_ashu/buying?source=avatar_menu_profile',
      username: '@techh_ashu',
      color: 'hover:border-accent-primary/50 hover:text-accent-primary'
    },
    {
      name: 'Upwork',
      icon: ExternalLink,
      href: 'https://www.upwork.com/freelancers/~011792acfe2a314012',
            ...
            <div className="space-y-8 animate-fade-in-right">
                ...
                <div className="space-y-6">
                  {contactInfo.map((info, index) => (
                    <div key={index} className="flex items-center space-x-4">
                      <div className={`p-3 bg-gradient-to-r ${info.color} rounded-lg shadow-glow-sm`}>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <button
                  ...
                  className="flex items-center justify-center space-x-2 px-6 py-4 bg-gradient-to-r from-accent-primary to-accent-secondary text-matteBlack-800 font-semibold rounded-lg hover:shadow-glow-lg transition-all duration-300 transform hover:scale-105 group relative overflow-hidden"
                >
                ...
                <div className="space-y-4">
                  {platforms.map((platform, index) => (
                    <a
                      key={index}
                      href={platform.href}
                      className={`flex items-center justify-between p-4 glass-effect border border-surface-border rounded-lg transition-all duration-300 group ${platform.color}`}
                    >
